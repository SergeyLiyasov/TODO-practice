...
from conduit import commands, user, profile, articles, geo
...
def register_shellcontext(app):
    ...
    def shell_context():
        ...
        return {
            ...
            'Geolocation': geo.models.Geolocation,
        }
